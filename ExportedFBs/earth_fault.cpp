 ...
 *** Version: 
 ***     0.0: 23/03/2016/gulzha - nxtControl GmbH - Template
...
const TDataIOID FORTE_earth_fault::scm_anEOWith[] = {0, 255, 0, 255};
const TForteInt16 FORTE_earth_fault::scm_anEOWithIndexes[] = {0, 2, -1, -1, -1};
const CStringDictionary::TStringId FORTE_earth_fault::scm_anEventOutputNames[] = {g_nStringIdINITO, g_nStringIdCNF, g_nStringIdSTART_TIMER, g_nStringIdRESET_OUT};
