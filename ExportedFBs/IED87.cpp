...
#include "IED87_gen.cpp"
#endif

DEFINE_FIRMWARE_FB(FORTE_IED87, g_nStringIdIED87)

const CStringDictionary::TStringId FORTE_IED87::scm_anDataInputNames[] = {g_nStringIdIpickup_current, g_nStringIdIcurrent, g_nStringIdcurve_type, g_nStringIdtime_dial_setting, g_nStringIdmin_trip_time};

const CStringDictionary::TStringId FORTE_IED87::scm_anDataInputTypeIds[] = {g_nStringIdREAL, g_nStringIdREAL, g_nStringIdINT, g_nStringIdREAL, g_nStringIdTIME};

const CStringDictionary::TStringId FORTE_IED87::scm_anDataOutputNames[] = {g_nStringIdtrip};

const CStringDictionary::TStringId FORTE_IED87::scm_anDataOutputTypeIds[] = {g_nStringIdBOOL};

const TForteInt16 FORTE_IED87::scm_anEIWithIndexes[] = {0, 5, -1};
const TDataIOID FORTE_IED87::scm_anEIWith[] = {0, 4, 3, 2, 255, 1, 255};
const CStringDictionary::TStringId FORTE_IED87::scm_anEventInputNames[] = {g_nStringIdINIT, g_nStringIdREQ, g_nStringIdCLEAR};

const TDataIOID FORTE_IED87::scm_anEOWith[] = {0, 255};
const TForteInt16 FORTE_IED87::scm_anEOWithIndexes[] = {-1, 0, -1, -1};
const CStringDictionary::TStringId FORTE_IED87::scm_anEventOutputNames[] = {g_nStringIdINITO, g_nStringIdCNF, g_nStringIdRESET_OUT};

const SFBInterfaceSpec FORTE_IED87::scm_stFBInterfaceSpec = {
...
const SCFB_FBInstanceData FORTE_IED87::scm_astInternalFBs[] = {
  {g_nStringIdovercurrent, g_nStringIdovercurrent},
  {g_nStringIdE_DELAY, g_nStringIdE_DELAY},
};

const SCFB_FBConnectionData FORTE_IED87::scm_astEventConnections[] = {
...
const SCFB_FBFannedOutConnectionData FORTE_IED87::scm_astFannedOutEventConnections[] = {
  {4, GENERATE_CONNECTION_PORT_ID_1_ARG(g_nStringIdRESET_OUT), -1},
};

const SCFB_FBConnectionData FORTE_IED87::scm_astDataConnections[] = {
...
const SCFB_FBNData FORTE_IED87::scm_stFBNData = {
